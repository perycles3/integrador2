...
public class ListarUsuarios extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listarUsuarios("http://192.168.8.108/services/listarUsuarios.php");
	...
	public void menuLateral(String roles) {
		...
		if (roles.equals("Administrador")) {
			...
			ArrayAdapter<String> adp = new ArrayAdapter<String>(ListarUsuarios.this,
			...
			String[] opciones = { nombreUsuario.toUpperCase() + "\n" + rolUsuario, "Incidencias", "Consultar Incidencia", "Registrar Medidor",
					"Consultar Medidores", "Reportes", "Cerrar Sesion" };
			ArrayAdapter<String> adp = new ArrayAdapter<String>(ListarUsuarios.this,
					android.R.layout.simple_list_item_1, opciones);
			menuLateral.setAdapter(adp);
			menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
	...
	public void listarUsuarios(String URL) {
		...
		listaUsuarios = (ListView) findViewById(R.id.listaUsuario);
				...
				for (int i = 0; i < response.length(); i++) {
					try {
						...
						lista.add("Codigo: " + jsonObject.getString("id") + "\n" 
								...
								+ "\n" + "Rol: " + jsonObject.getString("nombreRol"));

						ArrayAdapter<String> adapter = new ArrayAdapter<String>(ListarUsuarios.this,
